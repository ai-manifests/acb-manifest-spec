...
The Agent Cognitive Budget (ACB) protocol was originated by **David H. Friedel Jr.** of **MarketAlly** in 2026 as part of the ai-manifests protocol family ([acb-manifest.dev](https://acb-manifest.dev)). The specification text is released under the [Community Specification License 1.0](LICENSE.md) (Patent and Copyright). The companion specifications — [ADP](https://github.com/ai-manifests/adp-manifest-spec) (deliberation protocol) and [ADJ](https://github.com/ai-manifests/adj-manifest-spec) (journal) — share the same origin and licensing model.
